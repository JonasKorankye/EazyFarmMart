...
//        ImageView imageArrow;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.list_trans, null);
            ...
            holder.textQty = (TextView) convertView.findViewById(R.id.qty);
//            holder.imageArrow = (ImageView) convertView.findViewById(R.id.arrow);
        ...
        for(Map.Entry<String, Object> entry : setOfEntries){
            ...
            if (entry.getKey().contains("qty")){
                System.out.println("entry for qty::"+ entry.getValue());

                holder.textQty.setText(entry.getValue().toString());
            }
        }
